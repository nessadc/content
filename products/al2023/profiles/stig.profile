...
description: |- 
  This profile contains configuration checks that align to the DISA STIG for Red Hat Enterprise Linux 8 V2R1, however we are using it for Amazon Linux 2023.
